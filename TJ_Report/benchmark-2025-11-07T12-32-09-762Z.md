...
- **Run timestamp:** 2025-11-07T12:32:09.762Z

## Executive Summary

- TOON reduced input tokens by 400 (28.5%) compared with the other format.
- JSON responses arrived approximately 1.2ms faster than TOON.
- TOON conversion added 0.4ms of preprocessing time.

## Detailed Metrics

Format | Input tokens sent | Prompt tokens in response | Total tokens in response | Data prep time | Gemini response time
--- | --- | --- | --- | --- | ---
JSON | 1,404 | 1,398 | 1,646 | 0.0ms | 7284.0ms
TOON | 1,004 | 999 | 1,215 | 0.4ms | 7285.2ms
...
```json
{
  "summary": {
    "trends": [
      "Upsell Progress Bar and Tiered Rewards experiments showed positive lift.",
      "Referral Booster and Localized Playbooks are running with positive trends.",
      "APAC's churn rate is highe…
