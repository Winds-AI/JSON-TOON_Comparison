...
- **Run timestamp:** 2025-11-07T12:33:33.784Z

## Executive Summary

- TOON reduced input tokens by 400 (28.5%) compared with the other format.
- TOON responses arrived approximately 846.3ms faster than JSON.
...
--- | --- | --- | --- | --- | ---
JSON | 1,404 | 1,398 | 1,681 | 0.0ms | 7863.9ms
TOON | 1,004 | 999 | 1,200 | 0.2ms | 7017.6ms
...
```json
{
  "summary": {
    "trends": [
      "Upsell Progress Bar in NA significantly improved premium conversions.",
      "Tiered Rewards program boosted retention in NA.",
      "Gamified Onboarding increased feature adoption in APAC."…
